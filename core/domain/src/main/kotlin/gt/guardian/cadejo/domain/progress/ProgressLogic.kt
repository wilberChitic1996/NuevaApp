...
object ProgressLogic {
    ...
    fun award(profile: PlayerProfile, record: RunRecord): PlayerProfile {
    ...
    fun purchase(profile: PlayerProfile, id: UnlockId): PurchaseResult = when {
    ...
    fun selectSkin(profile: PlayerProfile, id: UnlockId?): PlayerProfile = when {
